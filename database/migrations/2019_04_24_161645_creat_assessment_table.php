...
class CreatAssessmentTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('assessments', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('applicantId')->unsigned()->index();
           ...
           $table->integer('chamberId')->unsigned()->index();
            ...
            $table->string('manufactoringCompanyTaxId');
            $table->string('manufactoringCompanyCommercialRegistry');
            ...
            $table->double('customsFees', 20, 2)->nullable();
