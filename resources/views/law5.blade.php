...
<body class="container">
	...
	<style>
		...
		body {
			...
			background-image: url(<?= $u ?>/storage/images/law5_new.png);
	...
	<div style=" font-size:10px;font-wight:bold;position: absolute;top:125px;right: 843px;"><?php if (!empty($certificate)) echo "TEND-$certificate->certificateNumber"; ?></div>
</body>
