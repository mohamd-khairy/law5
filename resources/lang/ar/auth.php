...
return [
    ...
    */
    ...
    'isEmailVerified'   => [
        'message' => ["يجب تأكيد البريد الالكتروني !."],
    ...
    'updatePasswordSuccess'   => ['message' => ["تم اعاده تعيين كلمه السر بنجاح ..."]],
    'NoUser'   => ['message' => ["لا يوجد مستخدم بهذا البريد الالكتروني ..."]],
    'noDelete'   => ['message' => ["لا يمكن حذف هذا العنصر .."]],
    'codeNotCorrect'   => ['message' => ["هذا الكود خطأ , حاول مره اخري.."]],
