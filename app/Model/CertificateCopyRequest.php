...
class CertificateCopyRequest extends Model
{
    ...
    protected $fillable = [
        "applicantId", "certificateId", "count", "isChamberMember", "isSubscriptionFeesPaid", "isIDAFeesPaid", "isFEIFeesPaid", "isIssued", "isDeleted", "issueDate", "CopyNumberFrom", "CopyNumberTo"
    ];
