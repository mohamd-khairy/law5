...
class EmployeeController extends Controller
{
  ...
  public function mail_test(Request $request)
  {
    ...
    Mail::to($request->email)->send(new AccountCreated($request->email,"password","mohamed"));
  }

  public function mail($email, $password,$name)
  {
    $setting = Setting::first();
    app('App\Http\Controllers\SettingsController')->SendMailSettings();
    Mail::to($email)->send(new AccountCreated($email, $password,$name));
  }
  ...
  public function createEmployee(Request $request)
  {
    ...
    $this->mail($user->email, $password,$user->name);
